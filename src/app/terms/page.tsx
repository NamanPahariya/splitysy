...
export const metadata: Metadata = {
  title: "Terms and Conditions | Splitsy",
};
    ...
    <main className="flex-1 bg-slate-50 px-4 py-12 text-slate-950">
      <article className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-12">
        ...
        <p className="mt-6 leading-7 text-slate-600">
          This page is a placeholder. Splitsy’s final Terms and Conditions have
          not been written or approved, so this content must not be treated as
          legal terms.
        </p>
        <Link
